...
<div class="login-nav-outer">
	<ul class="login-hmenu">
		...
		<li>
			<a href="index.php?id=5" <?php if ((isset($_GET['id'])) && ($_GET['id'] == 5)) { echo "class='active'"; } ?>><span class="l"></span><span class="r"></span><span class="t">About</span></a>
		</li>
        <li>
			<a href="index.php?id=7" <?php if ((isset($_GET['id'])) && ($_GET['id'] == 7)) { echo "class='active'"; } ?>><span class="l"></span><span class="r"></span><span class="t">* Please Donate *</span></a>
		</li>
...
<div class="login-post-inner login-article">
  ...
  if ((isset($_GET['id'])) && ($_GET['id'] == 7)) { include('donate.php'); };
  ?>
